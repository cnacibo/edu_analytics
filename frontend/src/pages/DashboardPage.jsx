            ...
            <div className="level-item">
              ...
              <div className="level-bar">
                <div
                  ...
                  style={{
                    width: `${(stats.programLevels.bachelor / stats.totalPrograms) * 100}%`,
                  }}
                ></div>
              </div>
            ...
            <div className="level-item">
              ...
              <div className="level-bar">
                <div
                  ...
                  style={{
                    width: `${(stats.programLevels.specialist / stats.totalPrograms) * 100}%`,
                  }}
                ></div>
              </div>
          ...
          <div className="cost-distribution">
            ...
            <div className="cost-item">
              ...
              <span className="cost-value">
                {stats.avgCostByType.specialist.toLocaleString()} ₽
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="seats-card hse">
            ...
            <div className="seats-details">
              ...
              <div className="seat-item">
                ...
                <span className="seat-value foreign">
                  {stats.seats.hse.foreign.toLocaleString()}
                </span>
              </div>
            </div>
          </div>
          <div className="seats-card vuz">
            ...
            <div className="seats-details">
              ...
              <div className="seat-item">
                <span className="seat-label">Для иностранцев</span>
                <span className="seat-value foreign">
                  {stats.seats.vuz.foreign.toLocaleString()}
                </span>
              </div>
            </div>
          </div>
